...
export default function Page() {
  return (
    <div className="min-h-screen bg-[#f5f5f7] text-[#1d1d1f] font-sans selection:bg-blue-100 selection:text-blue-900 overflow-x-hidden">
      ...
      <main>
        {/* 히어로 섹션 */}
        <section className="relative flex min-h-[90vh] flex-col items-center justify-center text-center pb-20 px-4">
          <div className="container mx-auto flex flex-col items-center max-w-5xl z-10">
            ...
            <Link href="/contact">
              <button className="rounded-full bg-[#0071e3] px-10 py-5 text-xl font-bold text-white shadow-lg hover:shadow-xl transition-shadow">
                지금 시작하기
              </button>
            </Link>
          </div>
